...
define_languages! {
    ...
    { Haxe, "haxe.ascii", "Haxe", define_colors!( [Color::Yellow, Color::White, Color::Red] : [Color::TrueColor{ r: 250, g: 178, b: 11 }, Color::TrueColor{ r:246, g:153, b:18 }, Color::TrueColor{ r: 244, g: 114, b: 22 }] ) },

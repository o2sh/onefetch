...
define_languages! {
    ...
    { Vhdl, Programming, "vhdl.ascii", define_colors!([Cyan, Yellow]) },
    ...
    { Wolfram, Programming, "wolfram.ascii", define_colors!([Red, White, Black] : [Rgb(255, 10, 1), Rgb(255, 255, 255), Rgb(0, 0, 0)]) },
